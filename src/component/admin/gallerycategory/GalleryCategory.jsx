...
import {createGalleryCategory,ResetClear} from '../../../action/galleryCategoryAction';
...
const {loading,error,message,galleryCategories,success}=useSelector(state=>state.gallerycategory)
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      dispatch(createGalleryCategory(category))
