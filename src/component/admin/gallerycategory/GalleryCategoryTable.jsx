...
import { getAllGalleryCategories, deleteGalleryCategory, ResetClear } from "../../../action/galleryCategoryAction";
...
const GalleryCategoryTable = () => {
  ...
  const { loading, error, message, galleryCategories, success, isdelete } = useSelector((state) => state.gallerycategory);
  ...
  useEffect(() => {
    ...
    dispatch(getAllGalleryCategories());
